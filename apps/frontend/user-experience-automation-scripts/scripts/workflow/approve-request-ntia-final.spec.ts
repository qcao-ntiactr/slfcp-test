...
test(`NTIA approves request with comment`, async ({ page }) => {
  ...
  await page.locator('textarea[name="comment"]').fill('Initial NTIA comment');
  ...
  console.log(`✅ Approved request ${formattedRequestId} with comment.`);
